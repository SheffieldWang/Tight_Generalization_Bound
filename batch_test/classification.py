...
class ExperimentManager:
    ...
    def save_results(self):
        ...
        # 保存DataFrame为CSV
        csv_path = f'results/experiment_results_{self.config["project_name"]}_{self.config["group_name"]}_{self.config["batch_size"]}.csv'
        ...
        pickle_path = f'results/full_results_{self.config["project_name"]}_{self.config["group_name"]}_{self.config["batch_size"]}.pkl'
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'n_repeats': n_repeats,
        'seed':seed,
        'project_name': f'batch_test_{data_type}',
        'group_name': f'n_samples_{n_samples}_batch_size_{batch_size}',
        'optimizer': optimizer
    }
