...
class ExperimentManager:
    ...
    def run_experiments(self):
        ...
        for i in range(self.n_repeats):
            ...
            seed = i
            print(seed)
            qnet = QuantumClassifier(ansatz_type="CNOT_angle",n_qubits=n_qubits,n_layers=n_layers,measurement_type="hamiltonian",hamiltonian=observable,seed=seed)
            ...
            self.metrics.update("error", train_accuracy, split="train", index_type="repeat")
            self.metrics.update("loss", test_loss, split="test", index_type="repeat")
            self.metrics.update("error", test_accuracy, split="test", index_type="repeat")
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'seed':seed,
        'optimizer':optimizer,
        'project_name': f'regression_{data_type}_{dataset_index}',
