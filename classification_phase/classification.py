...
if __name__ == "__main__":
    ...
    config = {
        ...
        'n_repeats': n_repeats,
        'seed':seed,
        'project_name': f'classification_{data_type}_{dataset_index}',
    ...
    train_loader, test_loader = get_quantum_dataloaders(n_qubits=n_qubits,n_samples=n_samples,batch_size=batch_size,data_type=f'{data_type}_{dataset_index}')


    experiment_manager = ExperimentManager(config)
    experiment_manager.run_experiments()

    print(f"Classification_{data_type}_{dataset_index} Task for Qubit Number: {n_qubits} and Samples Number: {n_samples} completed!")
