...
from train_utils import hinge_loss_fn,ClassificationTrainer
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'seed':seed,
        'optimizer': optimizer,
        'project_name': f'classification_{data_type}_optimizer_{optimizer}',
        'group_name': f'qubits_{n_qubits}_layers_{n_layers}_samples_{n_samples}_optimizer_{optimizer}',
    }

    
    train_loader, test_loader = get_quantum_dataloaders(n_qubits=n_qubits,n_samples=n_samples,batch_size=batch_size,data_type="classification_phase")
